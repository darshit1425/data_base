import 'package:data_base/income_expense/abc_helper/db_helper.dart';
import 'package:data_base/income_expense/category_screen/view/category_screen.dart';
import 'package:data_base/income_expense/home_screen/controller/abc_controller.dart';
                    ...
                    Expanded(
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Obx(
                                () => Text(
                              "${addControllor.filterStartingDateFind!.value.day}/0${addControllor.filterStartingDateFind!.value.month}/${addControllor.filterStartingDateFind!.value.year}",
                              style: TextStyle(
                                color: Colors.black,
                                fontWeight: FontWeight.bold,
                                fontSize: 17,
                    ...
                    Expanded(
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Obx(
                                () => Text(
                              "${addControllor.filterEndingDateFind!.value.day}/0${addControllor.filterEndingDateFind!.value.month}/${addControllor.filterEndingDateFind!.value.year}",
                              style: TextStyle(
                                color: Colors.black,
                                fontWeight: FontWeight.bold,
                                fontSize: 17,
                  ...
                  children: [
                    Expanded(
                      child: Obx(
                          ...
                          items:
                          addControllor.categoryNameList
                              .map(
                                (element) =>
                                DropdownMenuItem(
                                  child: Text(element),
                              ...
                              .toList(),
                          onChanged: (value) {
                            addControllor.selectedCategory
                                .value = value!;
                          },
                          icon: Icon(
                            Icons
